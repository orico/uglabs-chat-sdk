...
from ug_game.sdk.session import ChatSession  # noqa: E402
from ug_game.sdk.types import ChatCallbacks, ChatConfig  # noqa: E402
...
def integration_session(test_credentials):
    ...
    if not test_credentials:
        pytest.skip(
            "Test credentials not available. Set TEST_SERVICE_ACCOUNT_API_KEY and TEST_PLAYER_FEDERATED_ID"
        )
